...
const { findByNinAndName, create, findByNin, findByName, findById } = new driver_service_1.default();
const { CREATED, FETCHED, NO_QUERY } = constants_config_1.MESSAGES.DRIVER;
...
class DriverController {
    ...
    getDriverByNINAndName(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const nin = req.query.nin;
                const name = req.query.name;
                if (!nin && !name) {
                    return new response_util_1.default(statusCodes_util_1.BAD_REQUEST, false, NO_QUERY, res);
                }
                const driver = yield findByNinAndName(nin, name);
    ...
    getDriverByName(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const driver = yield findByName(name);
                return new response_util_1.default(statusCodes_util_1.OK, true, FETCHED, res, driver);
            }
            catch (error) {
                if (error instanceof httpException_util_1.default) {
    ...
    getDriverById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const driver = yield findById(id);
                return new response_util_1.default(statusCodes_util_1.OK, true, FETCHED, res, driver);
            }
            catch (error) {
                if (error instanceof httpException_util_1.default) {
